...
class TestPetShop(unittest.TestCase):
    ...
    def test_find_pet_by_price__returns_pet(self):
        price = find_pet_price(self.cc_pet_shop, "Arthur")
        self.assertEqual(900, price)
    
# --- OPTIONAL ---

    def test_customer_can_afford_pet__sufficient_funds(self):
        customer = self.customers[0]
        can_buy_pet = customer_can_afford_pet(customer, self.cc_pet_shop, "Arthur")
        self.assertEqual(True, can_buy_pet)

    def test_customer_can_afford_pet__insufficient_funds(self):
        customer = self.customers[1]
        can_buy_pet = customer_can_afford_pet(customer, self.cc_pet_shop, "Sir Lancelot")
